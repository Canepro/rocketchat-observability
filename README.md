...
- [Rocket.Chat + MongoDB + Prometheus + Grafana + Traefik - Reference Stack](#rocketchat--mongodb--prometheus--grafana--traefik---reference-stack)
  ...
  - [🌐 **Domain Configuration (Important!)**](#-domain-configuration-important)
  - [🆘 **Getting 404 Errors?**](#-getting-404-errors)
  - [🌐 Deploy to Azure Container Apps (ACA)](#-deploy-to-azure-container-apps-aca)
  ...
  - [🚀 Future Enhancements](#-future-enhancements)
    - [nginx Support for Production (Planned)](#nginx-support-for-production-planned)
