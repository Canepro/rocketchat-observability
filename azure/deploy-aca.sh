...
echo "==> Deploying infrastructure (ACR and environment only)"
...
echo "==> Images imported successfully. Container apps should now start automatically."
